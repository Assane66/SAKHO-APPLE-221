...
import { Home, Package, ShoppingCart, Repeat, Tag, Percent, ImageIcon, Users, Settings, Zap, Database } from "lucide-react";
...
const navLinks = [
  ...
  { href: "/admin/flash-sales", label: "Ventes Flash", icon: Zap, notificationKey: 'none' },
