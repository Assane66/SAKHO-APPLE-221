    ...
    <div className="container mx-auto max-w-3xl py-12 px-4 md:px-6">
      <Card>
        ...
        <CardContent className="space-y-6 text-lg text-muted-foreground">
          <p>
            Bienvenue chez <strong translate="no">Sakho Apple</strong>, votre boutique en ligne spécialisée dans la vente d’iPhones, smartphones et accessoires mobiles. Nous sommes une équipe de vendeurs dévoués, passionnés par le service client et par la qualité des produits que nous proposons.
          </p>
          <p>
          ...
          <p>
            Chez <strong translate="no">Sakho Apple</strong>, nous croyons que chaque client mérite un service personnalisé et attentif. Notre équipe est à votre écoute pour vous conseiller et vous aider à trouver le produit qui correspond le mieux à vos besoins.
          </p>
          <p>
          ...
          <p className="font-semibold text-foreground text-center pt-4">
            Merci de nous faire confiance et de choisir <span translate="no">Sakho Apple</span> pour vos achats mobiles !
          </p>
        </CardContent>
      </Card>
    </div>
